...
DEFINE_CGI_PARAM_CUSTOM  ("forward-override",           ACTION_FORWARD_RESOLVED_IP, ACTION_STRING_FORWARD_RESOLVED_IP, 0)
DEFINE_ACTION_STRING     ("forward-rule",               ACTION_FORWARD_RULE, ACTION_STRING_FORWARD_RULE)
DEFINE_CGI_PARAM_CUSTOM  ("forward-override",           ACTION_FORWARD_RULE, ACTION_STRING_FORWARD_RULE, 0)
